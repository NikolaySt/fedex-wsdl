...
/**
 * This class stands for SurchargeType EnumType
...
class SurchargeType
{
     ...
     * @uses self::VALUE_CANADIAN_DESTINATION
     * @uses self::VALUE_CLEARANCE_ENTRY_FEE
     * @uses self::VALUE_COD
     * @uses self::VALUE_CUT_FLOWERS
     * @uses self::VALUE_DANGEROUS_GOODS
     * @uses self::VALUE_DELIVERY_AREA
     * @uses self::VALUE_DELIVERY_CONFIRMATION
     * @uses self::VALUE_DOCUMENTATION_FEE
     * @uses self::VALUE_DRY_ICE
     * @uses self::VALUE_EMAIL_LABEL
     * @uses self::VALUE_EUROPE_FIRST
     * @uses self::VALUE_EXCESS_VALUE
     * @uses self::VALUE_EXHIBITION
     * @uses self::VALUE_EXPORT
     * @uses self::VALUE_EXTRA_SURFACE_HANDLING_CHARGE
     * @uses self::VALUE_EXTREME_LENGTH
     * @uses self::VALUE_FEDEX_INTRACOUNTRY_FEES
     * @uses self::VALUE_FEDEX_TAG
     * @uses self::VALUE_FICE
     * @uses self::VALUE_FLATBED
     * @uses self::VALUE_FREIGHT_GUARANTEE
     * @uses self::VALUE_FREIGHT_ON_VALUE
     * @uses self::VALUE_FREIGHT_TO_COLLECT
     * @uses self::VALUE_FUEL
     * @uses self::VALUE_HOLD_AT_LOCATION
     * @uses self::VALUE_HOME_DELIVERY_APPOINTMENT
     * @uses self::VALUE_HOME_DELIVERY_DATE_CERTAIN
     * @uses self::VALUE_HOME_DELIVERY_EVENING
     * @uses self::VALUE_INSIDE_DELIVERY
     * @uses self::VALUE_INSIDE_PICKUP
     * @uses self::VALUE_INSURED_VALUE
     * @uses self::VALUE_INTERHAWAII
     ...
     * @uses self::VALUE_METRO_DELIVERY
     * @uses self::VALUE_METRO_PICKUP
     ...
     * @uses self::VALUE_TRANSMART_SERVICE_FEE
     * @return string[]
     */
