...
class ServiceType
{
    ...
    /**
     * Constant for value 'INTERNATIONAL_PRIORITY_EXPRESS'
     * @return string 'INTERNATIONAL_PRIORITY_EXPRESS'
     */
    const VALUE_INTERNATIONAL_PRIORITY_EXPRESS = 'INTERNATIONAL_PRIORITY_EXPRESS';
    /**
     ...
     * @uses self::VALUE_INTERNATIONAL_PRIORITY_EXPRESS
    ...
    public static function getValidValues()
    {
        return array(
            ...
            self::VALUE_INTERNATIONAL_PRIORITY_EXPRESS,
