...
class LinearMeasure extends AbstractStructBase
{
     ...
     * Set Value value
     * @param float $value
     * @return \StructType\LinearMeasure
     */
    ...
    /**
     * Set Units value
     * @uses \EnumType\LinearUnits::valueIsValid()
     * @uses \EnumType\LinearUnits::getValidValues()
    ...
    public function setUnits($units = null)
    {
        ...
        if (!\EnumType\LinearUnits::valueIsValid($units)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $units, implode(', ', \EnumType\LinearUnits::getValidValues())), __LINE__);
        }
        $this->Units = $units;
        return $this;
    }
