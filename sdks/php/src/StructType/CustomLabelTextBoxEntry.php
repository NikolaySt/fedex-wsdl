...
class CustomLabelTextBoxEntry extends AbstractStructBase
{
     ...
     * @param \StructType\CustomLabelPosition $position
     * @param string $format
     ...
     */
    public function __construct(\StructType\CustomLabelPosition $topLeftCorner = null, \StructType\CustomLabelPosition $bottomRightCorner = null, \StructType\CustomLabelPosition $position = null, $format = null, array $dataFields = array(), $thermalFontId = null, $fontName = null, $fontSize = null, $rotation = null)
    {
        $this
     ...
     * @param \StructType\CustomLabelPosition $topLeftCorner
     * @return \StructType\CustomLabelTextBoxEntry
     */
     ...
     * @return \StructType\CustomLabelTextBoxEntry
     */
    public function setPosition(\StructType\CustomLabelPosition $position = null)
    {
    ...
    /**
     * Set Rotation value
     * @uses \EnumType\RotationType::valueIsValid()
     * @uses \EnumType\RotationType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $rotation
     * @return \StructType\CustomLabelTextBoxEntry
     */
    public function setRotation($rotation = null)
    {
        ...
        if (!\EnumType\RotationType::valueIsValid($rotation)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $rotation, implode(', ', \EnumType\RotationType::getValidValues())), __LINE__);
        }
