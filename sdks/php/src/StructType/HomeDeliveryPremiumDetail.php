...
class HomeDeliveryPremiumDetail extends AbstractStructBase
{
     ...
     * @uses \EnumType\HomeDeliveryPremiumType::valueIsValid()
     * @uses \EnumType\HomeDeliveryPremiumType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $homeDeliveryPremiumType
     * @return \StructType\HomeDeliveryPremiumDetail
     */
    public function setHomeDeliveryPremiumType($homeDeliveryPremiumType = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\HomeDeliveryPremiumType::valueIsValid($homeDeliveryPremiumType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $homeDeliveryPremiumType, implode(', ', \EnumType\HomeDeliveryPremiumType::getValidValues())), __LINE__);
        }
