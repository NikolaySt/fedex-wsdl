...
class CustomLabelBarcodeEntry extends AbstractStructBase
{
     ...
     */
    public function __construct(\StructType\CustomLabelPosition $position = null, $format = null, array $dataFields = array(), $barHeight = null, $thinBarWidth = null, $barcodeSymbology = null)
    {
        $this
     ...
     * Set Position value
     * @param \StructType\CustomLabelPosition $position
     * @return \StructType\CustomLabelBarcodeEntry
     */
    ...
    public function setBarcodeSymbology($barcodeSymbology = null)
    {
        ...
        if (!\EnumType\BarcodeSymbologyType::valueIsValid($barcodeSymbology)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $barcodeSymbology, implode(', ', \EnumType\BarcodeSymbologyType::getValidValues())), __LINE__);
        }
