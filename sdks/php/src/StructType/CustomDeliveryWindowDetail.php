...
class CustomDeliveryWindowDetail extends AbstractStructBase
{
     ...
     * @param \StructType\DateRange $requestRange
     * @param string $requestDate
     */
    public function __construct($type = null, $requestTime = null, \StructType\DateRange $requestRange = null, $requestDate = null)
    {
        $this
            ->setType($type)
    ...
    /**
     * Set Type value
     * @uses \EnumType\CustomDeliveryWindowType::valueIsValid()
     * @uses \EnumType\CustomDeliveryWindowType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $type
     * @return \StructType\CustomDeliveryWindowDetail
     */
    public function setType($type = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\CustomDeliveryWindowType::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $type, implode(', ', \EnumType\CustomDeliveryWindowType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
        return $this;
    }
     ...
     * @return \StructType\CustomDeliveryWindowDetail
     */
    public function setRequestRange(\StructType\DateRange $requestRange = null)
    {
