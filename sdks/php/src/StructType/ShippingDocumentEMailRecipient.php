...
class ShippingDocumentEMailRecipient extends AbstractStructBase
{
     ...
     * @uses \EnumType\EMailNotificationRecipientType::valueIsValid()
     * @uses \EnumType\EMailNotificationRecipientType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $recipientType
     * @return \StructType\ShippingDocumentEMailRecipient
     */
    public function setRecipientType($recipientType = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\EMailNotificationRecipientType::valueIsValid($recipientType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $recipientType, implode(', ', \EnumType\EMailNotificationRecipientType::getValidValues())), __LINE__);
        }
