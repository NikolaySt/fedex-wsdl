...
class ServiceSubOptionDetail extends AbstractStructBase
{
     ...
     * @uses \EnumType\FreightGuaranteeType::valueIsValid()
     * @uses \EnumType\FreightGuaranteeType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $freightGuarantee
     * @return \StructType\ServiceSubOptionDetail
     */
    public function setFreightGuarantee($freightGuarantee = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\FreightGuaranteeType::valueIsValid($freightGuarantee)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $freightGuarantee, implode(', ', \EnumType\FreightGuaranteeType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\EnumType\SmartPostIndiciaType::valueIsValid($smartPostIndicia)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $smartPostIndicia, implode(', ', \EnumType\SmartPostIndiciaType::getValidValues())), __LINE__);
        }
