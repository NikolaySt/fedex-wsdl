...
class TrackingId extends AbstractStructBase
{
     ...
     * @uses \EnumType\TrackingIdType::valueIsValid()
     * @uses \EnumType\TrackingIdType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $trackingIdType
     * @return \StructType\TrackingId
     */
    public function setTrackingIdType($trackingIdType = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\TrackingIdType::valueIsValid($trackingIdType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $trackingIdType, implode(', ', \EnumType\TrackingIdType::getValidValues())), __LINE__);
        }
