...
class AdditionalLabelsDetail extends AbstractStructBase
{
    ...
    /**
     * Set Type value
     * @uses \EnumType\AdditionalLabelsType::valueIsValid()
     * @uses \EnumType\AdditionalLabelsType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $type
     * @return \StructType\AdditionalLabelsDetail
     */
    public function setType($type = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\AdditionalLabelsType::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $type, implode(', ', \EnumType\AdditionalLabelsType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
        return $this;
    }
