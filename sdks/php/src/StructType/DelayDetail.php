...
class DelayDetail extends AbstractStructBase
{
    ...
    /**
     * Set Level value
     * @uses \EnumType\DelayLevelType::valueIsValid()
     * @uses \EnumType\DelayLevelType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $level
     * @return \StructType\DelayDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\EnumType\DelayLevelType::valueIsValid($level)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $level, implode(', ', \EnumType\DelayLevelType::getValidValues())), __LINE__);
        }
        $this->Level = $level;
        return $this;
    }
    ...
    /**
     * Set Point value
     * @uses \EnumType\DelayPointType::valueIsValid()
     * @uses \EnumType\DelayPointType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $point
     * @return \StructType\DelayDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\EnumType\DelayPointType::valueIsValid($point)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $point, implode(', ', \EnumType\DelayPointType::getValidValues())), __LINE__);
        }
        $this->Point = $point;
        return $this;
    }
    ...
    /**
     * Set Type value
     * @uses \EnumType\CommitmentDelayType::valueIsValid()
     * @uses \EnumType\CommitmentDelayType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $type
     * @return \StructType\DelayDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\EnumType\CommitmentDelayType::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $type, implode(', ', \EnumType\CommitmentDelayType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
        return $this;
    }
