...
class TaxpayerIdentification extends AbstractStructBase
{
    ...
    /**
     * Set TinType value
     * @uses \EnumType\TinType::valueIsValid()
     * @uses \EnumType\TinType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $tinType
     * @return \StructType\TaxpayerIdentification
     */
    public function setTinType($tinType = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\TinType::valueIsValid($tinType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $tinType, implode(', ', \EnumType\TinType::getValidValues())), __LINE__);
        }
