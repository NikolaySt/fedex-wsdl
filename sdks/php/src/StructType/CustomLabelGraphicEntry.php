...
class CustomLabelGraphicEntry extends AbstractStructBase
{
     ...
     */
    public function __construct(\StructType\CustomLabelPosition $position = null, $printerGraphicId = null, $fileGraphicFullName = null)
    {
        $this
     ...
     * Set Position value
     * @param \StructType\CustomLabelPosition $position
     * @return \StructType\CustomLabelGraphicEntry
     */
