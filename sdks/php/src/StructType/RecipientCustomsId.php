...
class RecipientCustomsId extends AbstractStructBase
{
    ...
    /**
     * Set Type value
     * @uses \EnumType\RecipientCustomsIdType::valueIsValid()
     * @uses \EnumType\RecipientCustomsIdType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $type
     * @return \StructType\RecipientCustomsId
     */
    public function setType($type = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\RecipientCustomsIdType::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $type, implode(', ', \EnumType\RecipientCustomsIdType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
        return $this;
    }
