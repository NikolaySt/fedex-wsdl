...
class NetExplosiveDetail extends AbstractStructBase
{
    ...
    /**
     * Set Type value
     * @uses \EnumType\NetExplosiveClassificationType::valueIsValid()
     * @uses \EnumType\NetExplosiveClassificationType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $type
     * @return \StructType\NetExplosiveDetail
     */
    public function setType($type = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\NetExplosiveClassificationType::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $type, implode(', ', \EnumType\NetExplosiveClassificationType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
        return $this;
    }
