...
class HazardousCommodityDescription extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \StructType\HazardousCommodityPackingDetail
     */
     ...
     * @param \StructType\HazardousCommodityPackingDetail $packingDetails
     ...
     * Set Id value
     * @param string $id
     * @return \StructType\HazardousCommodityDescription
     */
     ...
     * @uses \EnumType\HazardousCommodityPackingGroupType::valueIsValid()
     * @uses \EnumType\HazardousCommodityPackingGroupType::getValidValues()
    ...
    public function setPackingGroup($packingGroup = null)
    {
        ...
        if (!\EnumType\HazardousCommodityPackingGroupType::valueIsValid($packingGroup)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $packingGroup, implode(', ', \EnumType\HazardousCommodityPackingGroupType::getValidValues())), __LINE__);
        }
     ...
     * @return \StructType\HazardousCommodityPackingDetail|null
     */
     ...
     * @return \StructType\HazardousCommodityDescription
     */
    public function setPackingDetails(\StructType\HazardousCommodityPackingDetail $packingDetails = null)
    {
    ...
    public function setReportableQuantity($reportableQuantity = null)
    {
        ...
        if (!is_null($reportableQuantity) && !is_bool($reportableQuantity)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a bool, "%s" given', gettype($reportableQuantity)), __LINE__);
        }
     ...
     * @uses \EnumType\HazardousCommodityDescriptionProcessingOptionType::valueIsValid()
     * @uses \EnumType\HazardousCommodityDescriptionProcessingOptionType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string[] $processingOptions
     * @return \StructType\HazardousCommodityDescription
     */
    public function setProcessingOptions(array $processingOptions = array())
    {
        ...
        foreach ($processingOptions as $hazardousCommodityDescriptionProcessingOptionsItem) {
            if (!\EnumType\HazardousCommodityDescriptionProcessingOptionType::valueIsValid($hazardousCommodityDescriptionProcessingOptionsItem)) {
                $invalidValues[] = var_export($hazardousCommodityDescriptionProcessingOptionsItem, true);
            }
        }
        if (!empty($invalidValues)) {
            throw new \InvalidArgumentException(sprintf('Value(s) "%s" is/are invalid, please use one of: %s', implode(', ', $invalidValues), implode(', ', \EnumType\HazardousCommodityDescriptionProcessingOptionType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\EnumType\HazardousCommodityDescriptionProcessingOptionType::valueIsValid($item)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $item, implode(', ', \EnumType\HazardousCommodityDescriptionProcessingOptionType::getValidValues())), __LINE__);
        }
