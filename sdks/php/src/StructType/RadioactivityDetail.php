...
class RadioactivityDetail extends AbstractStructBase
{
     ...
     */
    public function __construct($transportIndex = null, $surfaceReading = null, $criticalitySafetyIndex = null, \StructType\Dimensions $dimensions = null)
    {
        $this
     ...
     * @param float $transportIndex
     * @return \StructType\RadioactivityDetail
     */
