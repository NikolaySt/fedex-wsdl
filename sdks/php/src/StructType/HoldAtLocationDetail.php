...
class HoldAtLocationDetail extends AbstractStructBase
{
     ...
     * @param \StructType\ContactAndAddress $locationContactAndAddress
     * @param string $locationType
     * @param string $locationId
     * @param int $locationNumber
     */
    public function __construct($phoneNumber = null, \StructType\ContactAndAddress $locationContactAndAddress = null, $locationType = null, $locationId = null, $locationNumber = null)
    {
        $this
     ...
     * @param string $phoneNumber
     * @return \StructType\HoldAtLocationDetail
     */
     ...
     * @return \StructType\HoldAtLocationDetail
     */
    public function setLocationContactAndAddress(\StructType\ContactAndAddress $locationContactAndAddress = null)
    {
     ...
     * @uses \EnumType\FedExLocationType::valueIsValid()
     * @uses \EnumType\FedExLocationType::getValidValues()
    ...
    public function setLocationType($locationType = null)
    {
        ...
        if (!\EnumType\FedExLocationType::valueIsValid($locationType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $locationType, implode(', ', \EnumType\FedExLocationType::getValidValues())), __LINE__);
        }
