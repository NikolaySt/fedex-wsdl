...
class EdtTaxDetail extends AbstractStructBase
{
     ...
     * @param string $name
     * @param \StructType\Money $taxableValue
     * @param string $description
     * @param string $formula
     * @param \StructType\Money $amount
     */
    public function __construct($taxType = null, $effectiveDate = null, $name = null, \StructType\Money $taxableValue = null, $description = null, $formula = null, \StructType\Money $amount = null)
    {
        $this
            ->setTaxType($taxType)
    ...
    /**
     * Set TaxType value
     * @uses \EnumType\EdtTaxType::valueIsValid()
     * @uses \EnumType\EdtTaxType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $taxType
     * @return \StructType\EdtTaxDetail
     */
    public function setTaxType($taxType = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\EdtTaxType::valueIsValid($taxType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $taxType, implode(', ', \EnumType\EdtTaxType::getValidValues())), __LINE__);
        }
     ...
     * @return \StructType\EdtTaxDetail
     */
    public function setTaxableValue(\StructType\Money $taxableValue = null)
    {
