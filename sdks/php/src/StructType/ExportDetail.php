...
class ExportDetail extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \StructType\DestinationControlDetail
     */
     ...
     * @param \StructType\DestinationControlDetail $destinationControlDetail
     */
    public function __construct($b13AFilingOption = null, $exportComplianceStatement = null, $permitNumber = null, \StructType\DestinationControlDetail $destinationControlDetail = null)
    {
        $this
     ...
     * @uses \EnumType\B13AFilingOptionType::valueIsValid()
     * @uses \EnumType\B13AFilingOptionType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $b13AFilingOption
     * @return \StructType\ExportDetail
     */
    public function setB13AFilingOption($b13AFilingOption = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\B13AFilingOptionType::valueIsValid($b13AFilingOption)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $b13AFilingOption, implode(', ', \EnumType\B13AFilingOptionType::getValidValues())), __LINE__);
        }
     ...
     * @return \StructType\DestinationControlDetail|null
     */
     ...
     * @return \StructType\ExportDetail
     */
    public function setDestinationControlDetail(\StructType\DestinationControlDetail $destinationControlDetail = null)
    {
