...
class DangerousGoodsContainer extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \StructType\HazardousCommodityContent[]
     */
     ...
     * @param \StructType\HazardousCommodityContent[] $hazardousCommodities
     */
     ...
     * @uses \EnumType\HazardousContainerPackingType::valueIsValid()
     * @uses \EnumType\HazardousContainerPackingType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $packingType
     * @return \StructType\DangerousGoodsContainer
     */
    public function setPackingType($packingType = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\HazardousContainerPackingType::valueIsValid($packingType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $packingType, implode(', ', \EnumType\HazardousContainerPackingType::getValidValues())), __LINE__);
        }
     ...
     * @uses \EnumType\RadioactiveContainerClassType::valueIsValid()
     * @uses \EnumType\RadioactiveContainerClassType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $radioactiveContainerClass
     * @return \StructType\DangerousGoodsContainer
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\EnumType\RadioactiveContainerClassType::valueIsValid($radioactiveContainerClass)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $radioactiveContainerClass, implode(', ', \EnumType\RadioactiveContainerClassType::getValidValues())), __LINE__);
        }
     ...
     * @return \StructType\HazardousCommodityContent[]|null
     */
    ...
    public function setHazardousCommodities(array $hazardousCommodities = array())
    {
        foreach ($hazardousCommodities as $dangerousGoodsContainerHazardousCommoditiesItem) {
            ...
            if (!$dangerousGoodsContainerHazardousCommoditiesItem instanceof \StructType\HazardousCommodityContent) {
                throw new \InvalidArgumentException(sprintf('The HazardousCommodities property can only contain items of \StructType\HazardousCommodityContent, "%s" given', is_object($dangerousGoodsContainerHazardousCommoditiesItem) ? get_class($dangerousGoodsContainerHazardousCommoditiesItem) : gettype($dangerousGoodsContainerHazardousCommoditiesItem)), __LINE__);
            }
        }
     ...
     * @throws \InvalidArgumentException
     * @param \StructType\HazardousCommodityContent $item
     * @return \StructType\DangerousGoodsContainer
     */
    public function addToHazardousCommodities(\StructType\HazardousCommodityContent $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \StructType\HazardousCommodityContent) {
            throw new \InvalidArgumentException(sprintf('The HazardousCommodities property can only contain items of \StructType\HazardousCommodityContent, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
