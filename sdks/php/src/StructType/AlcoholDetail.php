...
class AlcoholDetail extends AbstractStructBase
{
     ...
     * @uses \EnumType\AlcoholRecipientType::valueIsValid()
     * @uses \EnumType\AlcoholRecipientType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $recipientType
     * @return \StructType\AlcoholDetail
     */
    public function setRecipientType($recipientType = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\AlcoholRecipientType::valueIsValid($recipientType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $recipientType, implode(', ', \EnumType\AlcoholRecipientType::getValidValues())), __LINE__);
        }
