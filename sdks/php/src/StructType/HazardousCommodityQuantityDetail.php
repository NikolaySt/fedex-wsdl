...
class HazardousCommodityQuantityDetail extends AbstractStructBase
{
     ...
     * Set Amount value
     * @param float $amount
     * @return \StructType\HazardousCommodityQuantityDetail
     */
     ...
     * @uses \EnumType\HazardousCommodityQuantityType::valueIsValid()
     * @uses \EnumType\HazardousCommodityQuantityType::getValidValues()
    ...
    public function setQuantityType($quantityType = null)
    {
        ...
        if (!\EnumType\HazardousCommodityQuantityType::valueIsValid($quantityType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $quantityType, implode(', ', \EnumType\HazardousCommodityQuantityType::getValidValues())), __LINE__);
        }
