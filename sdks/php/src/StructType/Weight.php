...
class Weight extends AbstractStructBase
{
    ...
    /**
     * Set Units value
     * @uses \EnumType\WeightUnits::valueIsValid()
     * @uses \EnumType\WeightUnits::getValidValues()
    ...
    public function setUnits($units = null)
    {
        ...
        if (!\EnumType\WeightUnits::valueIsValid($units)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $units, implode(', ', \EnumType\WeightUnits::getValidValues())), __LINE__);
        }
        $this->Units = $units;
        return $this;
    }
