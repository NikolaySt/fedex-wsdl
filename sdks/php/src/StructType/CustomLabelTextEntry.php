...
class CustomLabelTextEntry extends AbstractStructBase
{
     ...
     */
    public function __construct(\StructType\CustomLabelPosition $position = null, $format = null, array $dataFields = array(), $thermalFontId = null, $fontName = null, $fontSize = null, $rotation = null)
    {
        $this
     ...
     * Set Position value
     * @param \StructType\CustomLabelPosition $position
     * @return \StructType\CustomLabelTextEntry
     */
