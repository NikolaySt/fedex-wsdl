...
class CustomerReference extends AbstractStructBase
{
     ...
     * @param string $customerReferenceType
     * @return \StructType\CustomerReference
     */
    public function setCustomerReferenceType($customerReferenceType = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\CustomerReferenceType::valueIsValid($customerReferenceType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $customerReferenceType, implode(', ', \EnumType\CustomerReferenceType::getValidValues())), __LINE__);
        }
