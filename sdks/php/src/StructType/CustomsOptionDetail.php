...
class CustomsOptionDetail extends AbstractStructBase
{
    ...
    /**
     * Set Type value
     * @uses \EnumType\CustomsOptionType::valueIsValid()
     * @uses \EnumType\CustomsOptionType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $type
     * @return \StructType\CustomsOptionDetail
     */
    public function setType($type = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\CustomsOptionType::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $type, implode(', ', \EnumType\CustomsOptionType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
        return $this;
    }
