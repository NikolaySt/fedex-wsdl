...
class SmartPostShipmentDetail extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \StructType\SmartPostShipmentProcessingOptionsRequested
     */
     ...
     * @param \StructType\SmartPostShipmentProcessingOptionsRequested $processingOptionsRequested
     * @param string $indicia
     * @param string $ancillaryEndorsement
     * @param string $hubId
     * @param string $customerManifestId
     */
    public function __construct(\StructType\SmartPostShipmentProcessingOptionsRequested $processingOptionsRequested = null, $indicia = null, $ancillaryEndorsement = null, $hubId = null, $customerManifestId = null)
    {
        $this
     ...
     * @return \StructType\SmartPostShipmentProcessingOptionsRequested|null
     */
     ...
     * @param \StructType\SmartPostShipmentProcessingOptionsRequested $processingOptionsRequested
     * @return \StructType\SmartPostShipmentDetail
     */
    public function setProcessingOptionsRequested(\StructType\SmartPostShipmentProcessingOptionsRequested $processingOptionsRequested = null)
    {
    ...
    /**
     * Set Indicia value
     * @uses \EnumType\SmartPostIndiciaType::valueIsValid()
     * @uses \EnumType\SmartPostIndiciaType::getValidValues()
    ...
    public function setIndicia($indicia = null)
    {
        ...
        if (!\EnumType\SmartPostIndiciaType::valueIsValid($indicia)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $indicia, implode(', ', \EnumType\SmartPostIndiciaType::getValidValues())), __LINE__);
        }
     ...
     * @uses \EnumType\SmartPostAncillaryEndorsementType::valueIsValid()
     * @uses \EnumType\SmartPostAncillaryEndorsementType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $ancillaryEndorsement
     * @return \StructType\SmartPostShipmentDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\EnumType\SmartPostAncillaryEndorsementType::valueIsValid($ancillaryEndorsement)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $ancillaryEndorsement, implode(', ', \EnumType\SmartPostAncillaryEndorsementType::getValidValues())), __LINE__);
        }
