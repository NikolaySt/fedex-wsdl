...
class DocTabZoneSpecification extends AbstractStructBase
{
     ...
     * @param int $zoneNumber
     * @return \StructType\DocTabZoneSpecification
     */
     ...
     * @uses \EnumType\DocTabZoneJustificationType::valueIsValid()
     * @uses \EnumType\DocTabZoneJustificationType::getValidValues()
    ...
    public function setJustification($justification = null)
    {
        ...
        if (!\EnumType\DocTabZoneJustificationType::valueIsValid($justification)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $justification, implode(', ', \EnumType\DocTabZoneJustificationType::getValidValues())), __LINE__);
        }
