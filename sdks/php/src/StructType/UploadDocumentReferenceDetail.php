...
class UploadDocumentReferenceDetail extends AbstractStructBase
{
     ...
     * @param int $lineNumber
     * @return \StructType\UploadDocumentReferenceDetail
     */
    ...
    public function setDocumentProducer($documentProducer = null)
    {
        ...
        if (!\EnumType\UploadDocumentProducerType::valueIsValid($documentProducer)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $documentProducer, implode(', ', \EnumType\UploadDocumentProducerType::getValidValues())), __LINE__);
        }
    ...
    public function setDocumentType($documentType = null)
    {
        ...
        if (!\EnumType\UploadDocumentType::valueIsValid($documentType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $documentType, implode(', ', \EnumType\UploadDocumentType::getValidValues())), __LINE__);
        }
    ...
    public function setDocumentIdProducer($documentIdProducer = null)
    {
        ...
        if (!\EnumType\UploadDocumentIdProducer::valueIsValid($documentIdProducer)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $documentIdProducer, implode(', ', \EnumType\UploadDocumentIdProducer::getValidValues())), __LINE__);
        }
