...
class PickupDetail extends AbstractStructBase
{
     ...
     * @param string $readyDateTime
     * @return \StructType\PickupDetail
     */
     ...
     * @uses \EnumType\PickupRequestType::valueIsValid()
     * @uses \EnumType\PickupRequestType::getValidValues()
    ...
    public function setRequestType($requestType = null)
    {
        ...
        if (!\EnumType\PickupRequestType::valueIsValid($requestType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $requestType, implode(', ', \EnumType\PickupRequestType::getValidValues())), __LINE__);
        }
     ...
     * @uses \EnumType\PickupRequestSourceType::valueIsValid()
     * @uses \EnumType\PickupRequestSourceType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $requestSource
     * @return \StructType\PickupDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\EnumType\PickupRequestSourceType::valueIsValid($requestSource)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $requestSource, implode(', ', \EnumType\PickupRequestSourceType::getValidValues())), __LINE__);
        }
