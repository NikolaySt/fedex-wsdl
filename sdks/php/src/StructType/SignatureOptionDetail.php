...
class SignatureOptionDetail extends AbstractStructBase
{
     ...
     * @param string $optionType
     * @return \StructType\SignatureOptionDetail
     */
    public function setOptionType($optionType = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\SignatureOptionType::valueIsValid($optionType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $optionType, implode(', ', \EnumType\SignatureOptionType::getValidValues())), __LINE__);
        }
