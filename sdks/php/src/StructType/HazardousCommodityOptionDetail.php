...
class HazardousCommodityOptionDetail extends AbstractStructBase
{
     ...
     * @uses \EnumType\HazardousCommodityLabelTextOptionType::valueIsValid()
     * @uses \EnumType\HazardousCommodityLabelTextOptionType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $labelTextOption
     * @return \StructType\HazardousCommodityOptionDetail
     */
    public function setLabelTextOption($labelTextOption = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\HazardousCommodityLabelTextOptionType::valueIsValid($labelTextOption)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $labelTextOption, implode(', ', \EnumType\HazardousCommodityLabelTextOptionType::getValidValues())), __LINE__);
        }
