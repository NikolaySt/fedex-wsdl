...
class RadionuclideDetail extends AbstractStructBase
{
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \StructType\RadionuclideActivity
     */
    public $Activity;
    /**
     ...
     * @param \StructType\RadionuclideActivity $activity
     * @param bool $exceptedPackagingIsReportableQuantity
     * @param string $physicalForm
     * @param string $chemicalForm
     */
    public function __construct($radionuclide = null, \StructType\RadionuclideActivity $activity = null, $exceptedPackagingIsReportableQuantity = null, $physicalForm = null, $chemicalForm = null)
    {
        $this
     ...
     * @param string $radionuclide
     * @return \StructType\RadionuclideDetail
     */
    ...
    /**
     * Get Activity value
     * @return \StructType\RadionuclideActivity|null
     */
     ...
     * @return \StructType\RadionuclideDetail
     */
    public function setActivity(\StructType\RadionuclideActivity $activity = null)
    {
    ...
    public function setExceptedPackagingIsReportableQuantity($exceptedPackagingIsReportableQuantity = null)
    {
        ...
        if (!is_null($exceptedPackagingIsReportableQuantity) && !is_bool($exceptedPackagingIsReportableQuantity)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a bool, "%s" given', gettype($exceptedPackagingIsReportableQuantity)), __LINE__);
        }
     ...
     * @uses \EnumType\PhysicalFormType::valueIsValid()
     * @uses \EnumType\PhysicalFormType::getValidValues()
    ...
    public function setPhysicalForm($physicalForm = null)
    {
        ...
        if (!\EnumType\PhysicalFormType::valueIsValid($physicalForm)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $physicalForm, implode(', ', \EnumType\PhysicalFormType::getValidValues())), __LINE__);
        }
