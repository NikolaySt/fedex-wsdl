...
class ClientDetail extends AbstractStructBase
{
     ...
     */
    public function __construct($accountNumber = null, $meterNumber = null, $integratorId = null, $region = null, \StructType\Localization $localization = null)
    {
        $this
    ...
    /**
     * Set Region value
     * @uses \EnumType\ExpressRegionCode::valueIsValid()
     * @uses \EnumType\ExpressRegionCode::getValidValues()
    ...
    public function setRegion($region = null)
    {
        ...
        if (!\EnumType\ExpressRegionCode::valueIsValid($region)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $region, implode(', ', \EnumType\ExpressRegionCode::getValidValues())), __LINE__);
        }
        $this->Region = $region;
        return $this;
    }
