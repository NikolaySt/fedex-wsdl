...
class FreightServiceCenterDetail extends AbstractStructBase
{
     ...
     * @param \StructType\Distance $localDistance
     ...
     * @param \StructType\ContactAndAddress $contactAndAddress
     */
    public function __construct($interlineCarrierCode = null, $interlineCarrierName = null, $additionalDays = null, $localService = null, \StructType\Distance $localDistance = null, $localDuration = null, $localServiceScheduling = null, array $limitedServiceDays = array(), $gatewayLocationId = null, $location = null, \StructType\ContactAndAddress $contactAndAddress = null)
    {
        $this
     ...
     * @param string $interlineCarrierCode
     * @return \StructType\FreightServiceCenterDetail
     */
    ...
    public function setLocalService($localService = null)
    {
        ...
        if (!\EnumType\ServiceType::valueIsValid($localService)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $localService, implode(', ', \EnumType\ServiceType::getValidValues())), __LINE__);
        }
     ...
     * @return \StructType\FreightServiceCenterDetail
     */
    public function setLocalDistance(\StructType\Distance $localDistance = null)
    {
     ...
     * @uses \EnumType\FreightServiceSchedulingType::valueIsValid()
     * @uses \EnumType\FreightServiceSchedulingType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $localServiceScheduling
     * @return \StructType\FreightServiceCenterDetail
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\EnumType\FreightServiceSchedulingType::valueIsValid($localServiceScheduling)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $localServiceScheduling, implode(', ', \EnumType\FreightServiceSchedulingType::getValidValues())), __LINE__);
        }
    ...
    public function setLimitedServiceDays(array $limitedServiceDays = array())
    {
        ...
        foreach ($limitedServiceDays as $freightServiceCenterDetailLimitedServiceDaysItem) {
            if (!\EnumType\DayOfWeekType::valueIsValid($freightServiceCenterDetailLimitedServiceDaysItem)) {
                $invalidValues[] = var_export($freightServiceCenterDetailLimitedServiceDaysItem, true);
            }
        }
        if (!empty($invalidValues)) {
            throw new \InvalidArgumentException(sprintf('Value(s) "%s" is/are invalid, please use one of: %s', implode(', ', $invalidValues), implode(', ', \EnumType\DayOfWeekType::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\EnumType\DayOfWeekType::valueIsValid($item)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $item, implode(', ', \EnumType\DayOfWeekType::getValidValues())), __LINE__);
        }
     ...
     * @return \StructType\FreightServiceCenterDetail
     */
    public function setContactAndAddress(\StructType\ContactAndAddress $contactAndAddress = null)
    {
