...
class PriorityAlertDetail extends AbstractStructBase
{
     ...
     * @uses \EnumType\PriorityAlertEnhancementType::valueIsValid()
     * @uses \EnumType\PriorityAlertEnhancementType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string[] $enhancementTypes
     * @return \StructType\PriorityAlertDetail
     */
    public function setEnhancementTypes(array $enhancementTypes = array())
    {
        ...
        foreach ($enhancementTypes as $priorityAlertDetailEnhancementTypesItem) {
            if (!\EnumType\PriorityAlertEnhancementType::valueIsValid($priorityAlertDetailEnhancementTypesItem)) {
                $invalidValues[] = var_export($priorityAlertDetailEnhancementTypesItem, true);
            }
        }
        if (!empty($invalidValues)) {
            throw new \InvalidArgumentException(sprintf('Value(s) "%s" is/are invalid, please use one of: %s', implode(', ', $invalidValues), implode(', ', \EnumType\PriorityAlertEnhancementType::getValidValues())), __LINE__);
        }
    ...
    public function addToEnhancementTypes($item)
    {
        ...
        if (!\EnumType\PriorityAlertEnhancementType::valueIsValid($item)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $item, implode(', ', \EnumType\PriorityAlertEnhancementType::getValidValues())), __LINE__);
        }
