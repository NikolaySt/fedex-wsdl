...
class Distance extends AbstractStructBase
{
    ...
    /**
     * Set Units value
     * @uses \EnumType\DistanceUnits::valueIsValid()
     * @uses \EnumType\DistanceUnits::getValidValues()
    ...
    public function setUnits($units = null)
    {
        ...
        if (!\EnumType\DistanceUnits::valueIsValid($units)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $units, implode(', ', \EnumType\DistanceUnits::getValidValues())), __LINE__);
        }
        $this->Units = $units;
        return $this;
    }
