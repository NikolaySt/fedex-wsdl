...
class InternationalControlledExportDetail extends AbstractStructBase
{
    ...
    /**
     * Set Type value
     * @uses \EnumType\InternationalControlledExportType::valueIsValid()
     * @uses \EnumType\InternationalControlledExportType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $type
     * @return \StructType\InternationalControlledExportDetail
     */
    public function setType($type = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\InternationalControlledExportType::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $type, implode(', ', \EnumType\InternationalControlledExportType::getValidValues())), __LINE__);
        }
        $this->Type = $type;
        return $this;
    }
