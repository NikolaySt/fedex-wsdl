...
class CommercialInvoice extends AbstractStructBase
{
     ...
     * @param \StructType\Money $freightCharge
     * @param \StructType\Money $taxesOrMiscellaneousCharge
     * @param string $taxesOrMiscellaneousChargeType
     * @param \StructType\Money $packingCosts
     * @param \StructType\Money $handlingCosts
     ...
     */
    public function __construct(array $comments = array(), \StructType\Money $freightCharge = null, \StructType\Money $taxesOrMiscellaneousCharge = null, $taxesOrMiscellaneousChargeType = null, \StructType\Money $packingCosts = null, \StructType\Money $handlingCosts = null, $specialInstructions = null, $declarationStatement = null, $paymentTerms = null, $purpose = null, $originatorName = null, $termsOfSale = null)
    {
        $this
     ...
     * @param string[] $comments
     * @return \StructType\CommercialInvoice
     */
     ...
     * @return \StructType\CommercialInvoice
     */
    public function setFreightCharge(\StructType\Money $freightCharge = null)
    {
     ...
     * @return \StructType\CommercialInvoice
     */
    public function setTaxesOrMiscellaneousCharge(\StructType\Money $taxesOrMiscellaneousCharge = null)
    {
     ...
     * @uses \EnumType\TaxesOrMiscellaneousChargeType::valueIsValid()
     * @uses \EnumType\TaxesOrMiscellaneousChargeType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $taxesOrMiscellaneousChargeType
     * @return \StructType\CommercialInvoice
     */
    public function setTaxesOrMiscellaneousChargeType($taxesOrMiscellaneousChargeType = null)
    {
        ...
        if (!\EnumType\TaxesOrMiscellaneousChargeType::valueIsValid($taxesOrMiscellaneousChargeType)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $taxesOrMiscellaneousChargeType, implode(', ', \EnumType\TaxesOrMiscellaneousChargeType::getValidValues())), __LINE__);
        }
     ...
     * @return \StructType\CommercialInvoice
     */
    public function setPackingCosts(\StructType\Money $packingCosts = null)
    {
     ...
     * @return \StructType\CommercialInvoice
     */
    public function setHandlingCosts(\StructType\Money $handlingCosts = null)
    {
    ...
    /**
     * Set Purpose value
     * @uses \EnumType\PurposeOfShipmentType::valueIsValid()
     * @uses \EnumType\PurposeOfShipmentType::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $purpose
     * @return \StructType\CommercialInvoice
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\EnumType\PurposeOfShipmentType::valueIsValid($purpose)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $purpose, implode(', ', \EnumType\PurposeOfShipmentType::getValidValues())), __LINE__);
        }
